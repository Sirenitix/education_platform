...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests().antMatchers(HttpMethod.POST,  "/full-register").permitAll()
                .and()
                ...
                .and()
                .authorizeRequests().antMatchers("/projects/projectPostImage/**").permitAll()
                .and()
                .authorizeRequests().antMatchers("/projects/projectPostFile/**").permitAll()
                .and()
