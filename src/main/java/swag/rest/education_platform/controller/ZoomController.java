...
public class ZoomController {
    ...
    public ResponseEntity<String> createMeeting(@RequestParam String time, @RequestBody UsersDto users, Principal principal) {
        String meeting = service.createMeeting(time, principal.getName(),users);
